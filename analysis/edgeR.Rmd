...
path <- paste0('results/complex-heatmap/genotype-edger-', tiss, '-interaction-fdr01.png')
png(path, width = 1000, height = 600, res = 120)
h_cerebellum <- Heatmap(
  .x,
...
plot_data %>%
  ...
  mutate(across(contains('logFC'), `-`)) %>%
  write_csv(paste0('results/complex-heatmap/', tiss, '-interaction-fdr01.csv'))
```
